...
class CursosModel extends Mysql{
    ...
    // InsertarIngresos(int $id_universidad, string $dp_nombre, int $dp_edad, int $dp_whatsApp, string $dp_email, string $dp_facebook, string $dp_domicilio, string $data_carrera,
    ...
    // }
    public function InsertarIngresos($info){
        $edad = $info['dp_edad'];


        $sql ="Insert into ingresos (edad) ";
        $sql .= "values( ";
        $sql .= "'$edad'";
